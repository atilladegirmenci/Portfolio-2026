...
import { TbBrandCSharp, TbBrandCpp,TbAi } from "react-icons/tb";
import { BiLogoUnity } from "react-icons/bi";
import { SiHuggingface, SiRapid, SiGithub, SiPostman,SiOpenai } from "react-icons/si";
...
const portfolioData = {
  ...
  techStack: [
    ...
    { name: "AI", icon: <TbAi />, color: "#1572B6" }, 
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-brand-base text-brand-accent font-sans selection:bg-brand-muted selection:text-brand-accent flex flex-col">
      
      {/* --- TOP NAVBAR --- */}
      <nav className="fixed top-0 w-full bg-brand-base/90 backdrop-blur-md border-b border-brand-card/50 z-50 transition-all">
      ...
      <main className="max-w-7xl mx-auto p-6 md:p-12 space-y-24 md:space-y-32 flex-grow">
        ...
        {/* --- ABOUT SECTION (GÜNCELLENDİ: Mor Işık Efekti Eklendi) --- */}
          ...
          <div className="flex-1 md:basis-1/3 flex flex-col items-center gap-6 shrink-0 group cursor-default">
             <div className="relative">
                {/* GÜNCELLENEN SATIR BURASI:
                   - from-brand-card (Koyu Gri Başlangıç)
                   - via-brand-accent (MOR ORTA GEÇİŞ - Yeni eklenen kısım)
                   - to-brand-muted (Açık Gri Bitiş)
                   - blur-md (Biraz daha yumuşak bir bulanıklık)
                   - opacity-40 / group-hover:opacity-70 (Daha belirgin olması için opaklık artırıldı)
                */}
             ...
             <a 
                ...
                className="px-8 py-3 bg-brand-accent text-white font-bold rounded-lg hover:bg-white hover:text-brand-base hover:scale-105 transition-all flex items-center gap-2 shadow-lg shadow-brand-accent/20"
              >
                Download CV
              </a>
          </div>
        ...
        <section id="education" className="scroll-mt-24">
          ...
          {/* GÜNCELLENDİ: bg-[#060340]/60 */}
          <div className="relative rounded-xl border border-white/5 overflow-hidden shadow-lg p-8 md:p-10 group bg-[#06042d]/60 backdrop-blur-xl hover:shadow-brand-accent/20 hover:shadow-2xl transition-all duration-300">
        ...
        <section id="skills" className="scroll-mt-24">
          ...
          <div className="relative overflow-hidden space-y-8 py-4">
            <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-brand-base to-transparent z-10"></div>
            <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-brand-base to-transparent z-10"></div>
        ...
        {/* --- CONTACT ME SECTION (GÜNCELLENDİ: bg-[#060340]/60) --- */}
        <section id="contact-me" className="scroll-mt-24 pb-20">
          ...
          <div className="rounded-xl border border-white/5 overflow-hidden shadow-lg p-12 text-center relative bg-[#06042d]/60 backdrop-blur-xl group hover:shadow-brand-accent/20 hover:shadow-2xl transition-all duration-300">
